...
public class FindAllAlertsEqualToStorageYearsEndpointTest {
	...
	private final String ENDPOINT_RESOURCE_BASE_URL = "/alerts/storageYears";

	@Test
	public void successOnInit() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.get(ENDPOINT_RESOURCE_BASE_URL + "/20").accept(MediaType.APPLICATION_JSON))
				...
				.andExpect(jsonPath("$.alerts[0].code").value(1))
				...
				.andExpect(jsonPath("$.alerts[0].storageYears").value(20))
				.andDo(print());
	}
	@Test
