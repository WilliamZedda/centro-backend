...
public class DeleteEndpointTest {
	...
	// L'idAlert di ricerca cambia di volta in volta. 5e9efcdb35ab0b4ede3e3609 non è più
	// valido per testare
	@Test
	public void successOnInit() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.delete(ENDPOINT_RESOURCE_BASE_URL + "/5e9efcdb35ab0b4ede3e3609")
	...
	public void failureOnInit() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.delete(ENDPOINT_RESOURCE_BASE_URL + "/test")
