...
public class getAllEndpointTest {
	...
	public void successOnInit() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.get(ENDPOINT_RESOURCE_BASE_URL).accept(MediaType.APPLICATION_JSON))
				...
				.andExpect(jsonPath("$.users[0].idUser").value(1))
				.andExpect(jsonPath("$.users[0].username").exists())
				.andExpect(jsonPath("$.users[0].username").value("b"))
				.andExpect(jsonPath("$.users[0].email").exists())
				.andExpect(jsonPath("$.users[0].email").value("b@b.b"))
				.andExpect(jsonPath("$.users[0].password").exists())
				.andExpect(jsonPath("$.users[0].password").value("b"))
				
				.andExpect(jsonPath("$.users[1].idUser").exists())
				.andExpect(jsonPath("$.users[1].idUser").value(3))
				.andExpect(jsonPath("$.users[1].username").exists())
				.andExpect(jsonPath("$.users[1].username").value("c"))
				...
				.andExpect(jsonPath("$.users[2].idUser").exists())
				.andExpect(jsonPath("$.users[2].idUser").value(4))
				.andExpect(jsonPath("$.users[2].username").exists())
				.andExpect(jsonPath("$.users[2].username").value("d"))
				.andExpect(jsonPath("$.users[2].email").exists())
